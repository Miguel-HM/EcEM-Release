 ...
 */
class getBookingsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BookingsRepository' shared autowired service.
     *
     * @return \App\Repository\BookingsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BookingsRepository.php';

        return $container->privates['App\\Repository\\BookingsRepository'] = new \App\Repository\BookingsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
